...
My research in soft matter focuses on the constitutive modeling and experimental characterization of polymer networks. By bridging the gap between molecular architecture and macroscopic response, we develop predictive models for materials subjected to diverse environmental and mechanical stimuli.
...
* **Cohen, N.**, *Phase Coexistence in Thermoresponsive PNIPAM Hydrogels Triggered by Mechanical Forces*, **Macromolecules**, 2016. [Link](https://pubs.acs.org/doi/10.1021/acs.macromol.5c03088)
* **Cohen, N.**, *Energetically motivated models for the mechanics of polymer networks*, [Journal Name], [Year].